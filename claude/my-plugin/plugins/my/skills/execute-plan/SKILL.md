...
If you are currently in planning mode (i.e., you have access to `ExitPlanMode`), STOP IMMEDIATELY. Do NOT proceed with any phase of this command. Instead, write the plan into `.my/plans/plan-[title].md` (create the directory if needed) and inform the user:
